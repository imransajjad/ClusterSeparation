...
include_string = "-I../include -IC:/MyLibs/GL/include -IC:/MyLibs/glfw/include  -std=c++11"
linker_string = "-L../lib -LC:/MyLibs/GL/lib -LC:/MyLibs/glfw/lib-mingw "
la_string = "-ldl -lglfw3dll -lglad -lopengl32"
main_exec = "main"
exec_ext = ".exe"
